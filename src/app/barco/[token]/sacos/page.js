...
const TarjetaDuracion = ({ titulo, duracion, viajes, icon: Icon, color = 'green', theme, sub, text, dk }) => {
  const colores = {
  ...
  return (
    <div className={`${card} border ${border} rounded-xl p-4 hover:shadow-lg transition-all duration-200`}>
