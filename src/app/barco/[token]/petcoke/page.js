...
export default function PetCokePage() {
  ...
  // FUNCIÓN PARA DETECTAR SALTOS ENTRE CORRELATIVOS
  const detectarSaltosCorrelativos = useCallback(() => {
    ...
    // Obtener todos los números correlativos de viajes completados
    ...
    // Verificar si el primer correlativo es 1
    if (minCorrelativo > 1) {
      saltos.push({
        tipo: 'inicio',
        desde: 1,
    ...
    // Detectar saltos entre correlativos
  ...
  // Función para ejecutar la comprobación y mostrar resultados
